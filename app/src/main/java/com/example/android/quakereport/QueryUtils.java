...
/**
 * Created by Steve Tran on 4/15/2017.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String requestUrl) {
        ...
        // Delay 2 seconds to simulate loading progress circle
/*        try {
            Thread.sleep(2000);
        ...
        try {
            jsonResponse = makeHttpRequest(url); // Data coming back is an inputStream
        } catch (IOException e) {
    ...
    private static ArrayList<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                // Getting an object in "features"
                JSONObject f = features.getJSONObject(i);

                // Getting the object "properties"
                JSONObject properties = new JSONObject(f.getString("properties"));

                // Obtain the properties
                double magnitue = properties.getDouble("mag");
                long time = properties.getLong("time");
                String urlId = properties.getString("url");

                // Add the properties into the ArrayList
                earthquakes.add(new Earthquake(magnitue, properties.getString("place"), time, urlId));
            }
